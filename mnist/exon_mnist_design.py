...
for r in radius:
    ...
    for _ in progress_bar:
        ...
        progress_bar.set_description('iteration {}/{} | beta {:.3f}, loss {:.3f}, recon {:.3f}, kl {:.3f}, cce {:.3f}'.format(
            step, PARAMS['iterations'], 
            beta, loss_[-1], error_[-1], kl_[-1], cce_[-1])) 
    ...
    for i in range(len(grid)):
        ...
        plt.axis('off')
        plt.tight_layout() 
    plt.savefig('./assets/{}/{}/reconstruction_radius_{}.png'.format(PARAMS['data'], asset_path, r),
    ...
    plt.savefig('./assets/{}/{}/latentspace_{}.png'.format(PARAMS['data'], asset_path, r),
                dpi=200, bbox_inches="tight", pad_inches=0.1)
    # plt.show()
    plt.close() 
...
reconstruction = []
for r in radius:
    reconstruction.append(Image.open('./assets/{}/{}/reconstruction_radius_{}.png'.format(PARAMS['data'], asset_path, r)))
