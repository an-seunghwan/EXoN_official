...
plt.savefig(
    "{}/vnat.png".format(model_path), dpi=200, bbox_inches="tight", pad_inches=0.1
)
plt.show()
plt.close()
#%%
...
plt.savefig(
    "{}/all_vnat.png".format(model_path), dpi=200, bbox_inches="tight", pad_inches=0.1
)
plt.show()
plt.close()
#%%
...
plt.savefig(
    "{}/vnat_corr.png".format(model_path), dpi=200, bbox_inches="tight", pad_inches=0.1
)
plt.show()
plt.close()
#%%
...
plt.savefig(
    "{}/blur.png".format(model_path), dpi=200, bbox_inches="tight", pad_inches=0.1
)
plt.show()
plt.close()
#%%
...
for i in range(21):
    ...
    axes.flatten()[i].axis("off")
plt.savefig(
    "{}/blur_many.png".format(model_path), dpi=200, bbox_inches="tight", pad_inches=0.1
)
plt.show()
plt.close()
#%%
...
for j in range(5):
    ...
    for i in range(11):
        ...
        axes[j][i].axis("off")
plt.savefig(
    "{}/oneaxis.png".format(model_path), dpi=200, bbox_inches="tight", pad_inches=0.1
)
plt.show()
plt.close()
#%%
